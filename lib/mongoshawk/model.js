...
function Model(datas) {
	...
	this.beforeMiddlewares = {
		...
		delete 	: function(id, options, callback) { callback(null, id, options); },
	...
	this.afterMiddlewares = {
		...
		delete 	: function(isDeleted, callback) { callback(null, isDeleted); },
...
Model.setType = function(type) {
	...
	if(typeof(type) !== "string")
		throw "type have to be a string";
...
Model.addReference = function(fieldPath, reference) {
	...
	if(!(reference instanceof Model) && typeof(reference) !== "function" && !(reference instanceof Array))
		throw "reference have to be a model, a function, a array of models or an array of functions";
	...
	if(reference instanceof Array) {
		...
		if(!(referenceItem instanceof Model) && typeof(referenceItem) !== "function")
			throw "reference have to be a function or a model";
 ...
 * @api public
 */
Model.deleteReference = function(fieldPath) {
	...
	// Check datas
	if(typeof(Model.references[fieldPath]) === "undefined")
 ...
 * @api public
 */
Model.deleteRelationship = function(fieldPath) {
	...
	// Check datas
	if(typeof(Model.relationships[fieldPath]) === "undefined")
...
/**
 * Add virtual field - !!!!!! NOT IMPLEMENTED !!!!!!
 *
 * @params {String}  fieldPath
...
Model.addVirtual = function(fieldPath, virtual) {
	...
	if(!(virtual instanceof Virtual))
		throw "virtual have to be a Virtual object";
...
/**
 * Get virtual fields - !!!!!! NOT IMPLEMENTED !!!!!!
 *
...
/**
 * Get a virtual field - !!!!!! NOT IMPLEMENTED !!!!!!
 *
 * @params {String} fieldPath
 * @return {Object} virtuals
 * @api public
...
/**
 * Delete a virtual field - !!!!!! NOT IMPLEMENTED !!!!!!
 *
 * @params {String} fieldPath
 * @api public
 */
Model.deleteVirtual = function(fieldPath) {
	/*
	// Check datas
	if(typeof(fieldPath) !== "string")
		throw "fieldPath have to be a string";
...
Model.prototype.setDatas = function(dataKey, dataValue) {
	...
	if(arguments.length === 2) {
		...
		if(typeof(dataKey) !== "string")
			throw "dataKey have to be a string";
		...
		if(typeof(dataKey) !== "object")
			throw "dataKey have to be an object";
...
Model.prototype.before = function(functionName, callback) {
	...
	// Check datas
	if(typeof(functionName) !== "string" || ["count", "list", "show", "create", "update", "delete", "save"].indexOf(functionName) === -1)
		throw "functionName have to be a string defined as count, list, show, create, update, delete or save";
	if(typeof(this[functionName]) !== "function")
		throw "functionName have to be an existing function";
...
Model.prototype.setParams = function(params) {
	...
	if(typeof(params) !== "object")
		throw "params have to be an object";
...
Model.prototype.count = function(filter, options, callback) {
	...
	self.beforeMiddlewares.count(filter, options, function(err, beforeFilter, beforeOptions) {
		...
		if(typeof(filter) !== "object")
			throw "filter have to be an object";
...
Model.prototype.list = function(filter, fields, options, callback) {
	...
	self.beforeMiddlewares.list(filter, fields, options, function(err, beforeFilter, beforeFields, beforeOptions) {
		...
		// Parse fields
		parseFieldsResult       	= parseFields(references, relationships, fields);
...
Model.prototype.show = function(id, fields, options, callback) {
	...
	self.beforeMiddlewares.show(id, fields, options, function(err, beforeId, beforeFields) {
		...
		if(!(id instanceof Schema.Types.ObjectId) && !(id instanceof Object))
			throw "id have to be an ObjectId or an Object";
		if(typeof(fields) !== "object")
			throw "fields have to be an object";
		if(typeof(options) !== "object")
			throw "options have to be an object";
...
Model.prototype.create = function(body, options, callback) {
	...
	self.beforeMiddlewares.create(body, options, function(err, beforeBody, beforeOptions) {
		...
		if(typeof(body) !== "object")
			throw "body have to be an object";
		if(typeof(options) !== "object")
			throw "options have to be an object";
		...
		collection.insert(body, function(err, result) {
			...
			// After create
			self.afterMiddlewares.create(result, function(err, afterResult) {
...
Model.prototype.delete = function(id, options, callback) {
	...
	// Before delete
	self.beforeMiddlewares.delete(id, options, function(err, beforeId, beforeOptions) {
		...
		// Insert datas
		collection.remove(filterDelete, function(err, isDeleted) {
			...
			// After delete
			self.afterMiddlewares.delete(isDeleted, function(err, afterIsDeleted) {
				...
				// Callback
				if(callback) callback(null, afterIsDeleted);
...
Model.prototype.save = function(options, callback) {
	...
	self.beforeMiddlewares.save(options, function(err, beforeOptions) {
		...
		if(Object.keys(datas).length === 0)
			throw "instance datas have to be defined";
 ...
 * @api private
 */
var parseFields = function(references, relationships, fields, prefix) {
	...
	if(typeof(relationships) !== "object")
		throw "relationships have to be an object";
	if(typeof(fields) !== "object")
		throw "fields have to be an object";
	if(typeof(prefix) !== "string")
		throw "prefix have to be an string";
		...
		// If not relationship
			...
			// If field is sub-document
				...
				// If object (embeded)
					...
					// Get fields
					var resultParsedFields 		= parseFields(references, relationships, fields[fieldKey]["$fields"], prefix+fieldKey+".");
...
var requiredFieldsFromQuery = function(references, relationships, relationshipCondition) {
	...
	if(typeof(relationshipCondition) !== "object")
		throw "relationshipCondition have to be an object";
...
var requiredRelatedFieldsFromQuery = function(references, relationships, fieldValue) {
	...
	if(typeof(fieldValue) === "undefined")
		throw "fieldValue have to be defined";
