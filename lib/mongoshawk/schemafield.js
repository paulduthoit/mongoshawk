        ...
        function(asyncCallback) {
            ...
            if(self.array) {
                ...
                if(self.subSchema) {
                    ...
                    value.forEach(function(valueItem, valueIndex) {
                        ...
                        self.subSchema.validate(valueItem, action, function(validationError) {
                ...
                // If field is not a sub-schema
                    ...
                    value.forEach(function(valueItem, valueIndex) {
                        ...
                        if(self.validation instanceof ValidationSet) {
                            ...
                            self.validation.validate(valueItem, action, function(validationError) {
            ...
            // Must not be an array
                ...
                if(self.subSchema) {
                    ...
                    // Get sub schema validation
                    self.subSchema.validate(value, action, function(validationError) {
                ...
                // If field is not a sub-schema
                    ...
                    if(self.validation instanceof ValidationSet) {
                        ...
                        // Get field validation
                        self.validation.validate(value, action, function(validationError) {
