 ...
 */
var SchemaTypeObjectId = mongodb.BSONPure.ObjectID;
...
SchemaTypeObjectId.validate = function(value) {
    ...
    if(typeof(value) === "undefined")
        throw "value have to be defined";

    // Check if object id
    if(value instanceof SchemaTypeObjectId) return true;
    if(value instanceof mongodb.BSONPure.ObjectID) return true;
...
SchemaTypeObjectId.convert = function(value) {
    ...
    if(value instanceof mongodb.BSONPure.ObjectID) return value;
